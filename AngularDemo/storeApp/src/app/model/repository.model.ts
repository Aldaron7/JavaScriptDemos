...
export class Model {
  ...
  constructor(private dataSource: RestDataSource, private messageService: MessageService) {
    // this.products = new Array<Product>();
    // this.dataSource.getData().forEach(p => this.products.push(p));
    this.dataSource.getData().subscribe(data => (this.products = data), error => this.messageService.reportMessage(error));
  }
  getProducts(): Product[] {
